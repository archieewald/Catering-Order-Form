...
export default class OrderDetails extends React.Component{
    ...
    handleChangeCheck= (event) => {
        this.props.onChangeCheck(event.target);
    }
        ...
        return(
            <div className='order_details box'>
                ...
                <div className='name_form'>
                    ...
                    <span style={{color: "red", display: this.props.visName}}>Pole imię musi zostać uzupełnione</span>
                    <input id='name' type='text' value={this.props.name} onChange={this.handleChangeText}/>
                ...
                <div className='phone_form'>
                    ...
                    <span style={{color: "red", display: this.props.visPhone}}>Pole z numerem telefonu musi zostać uzupełnione</span>
                ...
                <div className='email_form'>
                    ...
                    <span style={{color: "red", display: this.props.visEmail}}>Pole email musi zostać uzupełnione i zawierać znak @</span>
                ...
                <div className='date_form'>
                    ...
                    <span style={{color: "red", display: this.props.visDate}}>Pole z datą musi zostać uzupełnione</span>
                    <DateTimePicker id='date' time={false}/>
            {/*//WALIDACJA DATY!!!*/}
                    <label className='label' htmlFor='time'>Podaj godzinę realizacji zamówienia<span className='required'>*</span></label>
                    <span style={{color: "red", display: this.props.visTime}}>Pole z godziną musi zostać uzupełnione</span>
                ...
                <div className='delivery_option_form'>
                    ...
                    <span style={{color: "red", display: this.props.visDelivery}}>Proszę zaznaczyć opcję dostawy</span>
                ...
                <div className='address_form'>
                    ...
                    <span style={{color: "red", display: this.props.visAddress}}>Proszę podać adres dostawy</span>
